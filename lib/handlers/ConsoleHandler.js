...
class ConsoleHandler {
	...
	#handleBuildStatusEvent({level, projectName, projectType, status}) {
		...
		case "project-build-end":
			...
			this._getProgressBar()?.increment(this.#progressBarProjectWeight);
			break;
		case "project-build-skip":
			...
			this._getProgressBar()?.increment(this.#progressBarProjectWeight + projectMetadata.projectTasks.size);
			break;
		default:
			break;
		}
