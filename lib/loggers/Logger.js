 ...
 * <br><br>
 * Emits <code>ui5.log</code> events on the [<code>process</code>]{@link https://nodejs.org/api/process.html} object, which can
 * be handled by an instance of [@ui5/logger/handlers/ConsoleHandler]{@link @ui5/logger/handlers/ConsoleHandler}.
 * <br><br>
 * If no listener is attached to the the event, messages are logged directly using <code>console.log</code>.
 *
 * @public
 * @class
